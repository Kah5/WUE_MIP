# Code from Christy Rollinson at https://github.com/PalEON-Project/MIP_Utils/blob/master/Phase2_region/extract_output_region.R
...
extract.paleon.site.pft <- function(model, model.dir, vars, xmin=-100, xmax=-60, ymin=35, ymax=50, yrmin=850, yrmax=2010){
