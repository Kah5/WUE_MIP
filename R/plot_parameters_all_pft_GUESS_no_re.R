...
for(i in 1:length(spec)){
  png(height = 6, width = 12, units = "in", res = 200, paste0("outputs/gwbi_model/LPJ_GUESS_no_re/traceplot_", spec[i],".png"))
  par(mfrow = c(2,4))
...
# save acfplots:
for(i in 1:length(spec)){
  png(height = 6, width = 12, units = "in", res = 200, paste0("outputs/gwbi_model/LPJ_GUESS_no_re/acfplot_", spec[i],".png"))
...
for(i in 1:length(spec)){
 ...
 ggsave( paste0("outputs/gwbi_model/LPJ_GUESS_no_re/parameter_ests_", spec[i],".png"))
...
saveRDS(rsq.site.df,"outputs/gwbi_model/LPJ_GUESS_no_re/rsq.df.rds")
